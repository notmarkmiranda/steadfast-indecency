...
ActiveRecord::Schema[7.1].define(version: 2024_02_24_201816) do
  ...
  create_table "choices", force: :cascade do |t|
    ...
    t.index ["entry_id"], name: "index_choices_on_entry_id"
    t.index ["option_id"], name: "index_choices_on_option_id"
    t.index ["question_id"], name: "index_choices_on_question_id", unique: true
  end
